...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in bilibili/pgc/gateway/player/v2/playurl_pb2_grpc.py depends on'
...
def add_PlayURLServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('bilibili.pgc.gateway.player.v2.PlayURL', rpc_method_handlers)
