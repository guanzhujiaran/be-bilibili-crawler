...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in bilibili/broadcast/message/main/search_pb2_grpc.py depends on'
...
def add_SearchServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('bilibili.broadcast.message.main.Search', rpc_method_handlers)
