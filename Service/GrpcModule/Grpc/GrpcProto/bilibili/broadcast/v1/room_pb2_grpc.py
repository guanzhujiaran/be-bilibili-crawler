...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in bilibili/broadcast/v1/room_pb2_grpc.py depends on'
...
def add_BroadcastRoomServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('bilibili.broadcast.v1.BroadcastRoom', rpc_method_handlers)
